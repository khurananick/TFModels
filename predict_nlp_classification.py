...
intents_file       = sys.argv[2]
learning_logs_file = sys.argv[3]
model_file         = sys.argv[4]
uinputs            = json.loads(sys.argv[5])
...
model = tflearn.DNN(net, tensorboard_dir=learning_logs_file)
...
for uinput in uinputs:
    responses.append(response(uinput))
